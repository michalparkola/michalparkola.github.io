...
heroImage: "../../assets/omt-04-five-to-one.jpeg"
---

import { Image } from 'astro:assets';
import ratioImg from '../../assets/ratio-of-positivity.jpeg';

**What holds a great team together despite inevitable
conflict?**

[John Gottman](https://www.gottman.com/about/) has some answers. John has been studying married couples
...
the concept of [The Magic Ratio](https://www.gottman.com/blog/the-magic-relationship-ratio-according-science/) which states:
...
And on top of that, [as mentioned in the previous installment](https://remoteleader.substack.com/p/identify-the-good-before-looking), amplifying the good parts tends to work better than fixating
on problems, weaknesses and deficiencies.

<Image src={ratioImg} alt="5:1 ratio of positive to negative interactions" width={800} />
