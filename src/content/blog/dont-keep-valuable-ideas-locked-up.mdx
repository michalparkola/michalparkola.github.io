...
heroImage: "../../assets/shell.jpeg"
---

import { Image } from 'astro:assets';
import asyncAbcImg from '../../assets/dont-keep-ideas-locked-asyncabc.jpg';
...
Side note: That’s why the C in [AsyncABC](/blog/enable-knowledge-to-grow-over-time-with-asyncabc/) is “*Connect Everything*”

<Image src={asyncAbcImg} alt="AsyncABC" width={800} />
